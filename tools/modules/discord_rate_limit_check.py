...
def check_rate_limits():
    ...
    invite_reset_time = datetime.utcfromtimestamp(invite_reset_timestamp).strftime('%Y-%m-%d %H:%M:%S')
    ...
    reset_time = datetime.utcfromtimestamp(reset_timestamp).strftime('%Y-%m-%d %H:%M:%S')
